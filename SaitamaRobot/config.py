...
class Config(object):
    ...
    OWNER_ID = 768318846  # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "Uday"
    ...
    #RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'postgres://zlnssgij:ihFf7hoj4tdizQOj9YabAjhnQ8ASkiCK@raja.db.elephantsql.com:5432/zlnssgij'  # needed for any database modules
    LOAD = []
